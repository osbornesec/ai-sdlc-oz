...
class TestContextCoverage:
    ...
    def test_run_context_with_existing_lock(self, temp_project_dir: Path, capsys):
        ...
        (feature_dir / "00-idea-test-feature.md").write_text(
            "# Test Feature\nidea content"
        )
    ...
    def test_get_context_command_libraries_specified(
