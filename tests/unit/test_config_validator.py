...
class TestConfigValidator:
    ...
    def test_validate_config_missing_version(self):
        ...
        with pytest.raises(ConfigValidationError, match="Missing required field: version"):
    ...
    def test_validate_config_missing_steps(self):
        ...
        with pytest.raises(ConfigValidationError, match="Missing required field: steps"):
            validate_config(config)
    ...
    def test_validate_config_missing_active_dir(self):
        ...
        with pytest.raises(ConfigValidationError, match="Missing required field: active_dir"):
            validate_config(config)
    ...
    def test_validate_config_missing_done_dir(self):
        ...
        with pytest.raises(ConfigValidationError, match="Missing required field: done_dir"):
            validate_config(config)
    ...
    def test_validate_config_missing_prompt_dir(self):
        ...
        with pytest.raises(ConfigValidationError, match="Missing required field: prompt_dir"):
            validate_config(config)
    ...
    def test_validate_config_invalid_dir_type(self):
        ...
        with pytest.raises(ConfigValidationError, match="'active_dir' must be a string"):
            validate_config(config)
    ...
    def test_validate_config_dir_with_path_separator(self):
        ...
        with pytest.raises(ConfigValidationError, match="'active_dir' must be a simple directory name"):
            validate_config(config)
    ...
    def test_validate_config_dir_with_backslash(self):
        ...
        with pytest.raises(ConfigValidationError, match="'done_dir' must be a simple directory name"):
            validate_config(config)
    ...
    def test_validate_config_invalid_context7_type(self):
        ...
        with pytest.raises(ConfigValidationError, match="'context7' must be a dictionary"):
            validate_config(config)
    ...
    def test_validate_config_invalid_context7_enabled(self):
        ...
        with pytest.raises(ConfigValidationError, match="'context7.enabled' must be a boolean"):
            validate_config(config)
    ...
    def test_validate_steps_sequence_wrong_prefix(self):
        ...
        with pytest.raises(ConfigValidationError, match="Step 1 should start with '01-'"):
            validate_steps_sequence(steps)
    ...
    def test_validate_steps_sequence_duplicates(self):
        ...
        with pytest.raises(ConfigValidationError, match="Step 2 should start with '02-'"):
            validate_steps_sequence(steps)
